-- ============================================================
-- Checkmark Audio -- Team-Scoped Access Migration
-- Run this in your Supabase SQL Editor (Dashboard > SQL Editor)
--
-- This migration:
--   1. Creates ALL tables the app references (filling in gaps)
--   2. Adds a teams table + team_id column for team isolation
--   3. Replaces admin-only write policies with team-scoped RLS
--   4. Auto-fills team_id via trigger so the frontend needs no changes
--
...
-- 1b. intern_users table (may already exist from initial setup)
...
-- Returns team_id of the authenticated user.
-- Falls back to the default team for brand-new signups.
...
-- Auto-fills team_id on INSERT when the frontend omits it.
...
-- =============================
-- PART 3: EXISTING TABLES
-- Add team_id, replace policies
-- =============================
...
-- =============================
-- PART 4: MISSING TABLES
-- Create + team_id + policies
-- =============================
