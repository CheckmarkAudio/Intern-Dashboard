# Page visual drafts (per menu section)

Each folder matches a **Menu-Sidebar** label. Put **visual-only drafts** (PNG, etc.) for that screen here before implementation.

| Folder | Opens from menu |
|--------|------------------|
| `Overview/` | Overview |
| `Tasks/` | Tasks |
| `Calendar/` | Calendar |
...
| `Team Hub/` | Admin → Team Hub |
| `Assign Tasks/` | Admin → Assign Tasks |
